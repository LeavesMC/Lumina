Welcome to the Lumina roadmap! Get a glimpse into what our team is focused on. (this roadmap is inspired by the [Kotlin roadmap](https://kotlinlang.org/docs/roadmap.html))
